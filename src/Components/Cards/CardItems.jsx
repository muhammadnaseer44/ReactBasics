...
function CardItem() {
    const arrOfObj = [
        ...
        {
            'name': 'Banana',
            'title': 'Portable and naturally sweet, bananas are perfect on-the-go energy.'
        },
        ,
        {
            'name': 'Mango',
            'title': 'The king of fruits, celebrated for its luscious sweetness and tropical flavor'
        },
        {
            'name': 'Orange',
